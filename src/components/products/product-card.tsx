...
export function ProductCard({ product }: Props) {
    ...
    return (
        <Link href={`/productos/${categoriesDictionary[product.category]}/${product.slug}`} className="w-full">
            <div className="w-full relative rounded-sm overflow-hidden max-w-md mx-auto bg-gradient-to-r from-[#1D2235] to-[#121318] p-1.5">
                <Rays />
                <Beams />
                <div className="relative z-10">
                    <Lens hovering={hovering} setHovering={setHovering}>
                        <img
                            ...
                            width={500}
                            height={220}
                            className="rounded-sm max-h-[220px] w-full object-cover"
                        />
                    </Lens>
                    <motion.div
                        animate={{
                    ...
                    >
                        <h2 className="text-white text-lg text-left font-bold capitalize">
                            {product.title}
                        </h2>
