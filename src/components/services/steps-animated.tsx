...
import { TextFocus } from '../about/text-focus';
...
const features = [
  {
    ...
    content:
      'Ofrecemos una amplia gama de productos para satisfacer tus necesidades.',
  ...
  },
  {
    ...
    title: 'Venta rápida',
    content:
      'Tus compras se procesan de manera rápida y eficiente, garantizando una experiencia fluida.',
  ...
  },
  {
    ...
    content:
      'Nuestro equipo está siempre disponible para ayudarte y resolver tus dudas.',
  ...
  },
  {
    ...
    content:
      'Ofrecemos descuentos exclusivos para nuestros clientes más activos.',
    icon: <Code className="h-6 w-6" />,
    image:
      'https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=2070&auto=format&fit=crop',
  },
      ...
      <div className="mx-auto w-full">
        <div className="relative mx-auto mb-12 max-w-2xl sm:text-center">
          <div className="relative z-10">
            ...
            />
            <p>
              Cada uno de los servicios que brindamos en Cubit Tecnología está diseñado para ayudarte a alcanzar tus objetivos de manera más eficiente y efectiva.
            </p>
          </div>
          <div
                ...
                <motion.div
                  className={cn(
                    ...
                    index === currentFeature
                      ? 'border-secondary/20 bg-secondary/10 text-white scale-105 [box-shadow:0_0_15px_#2563eb]'
                      : 'border-muted-foreground bg-muted text-slate-800',
                  )}
                >
                  {feature.icon}
                </motion.div>
