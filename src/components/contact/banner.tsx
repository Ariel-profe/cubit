...
export const Banner = () => {
    return (
        <div
            className="relative isolate w-full overflow-hidden rounded-sm py-20"
            style={{
                background:
        ...
        >
            ...
            <div className="relative isolate overflow-hidden px-4 py-12 sm:px-24">
                <p className="w-fit rounded-sm bg-white px-4 py-1 text-center text-base leading-7 font-semibold text-black uppercase lg:text-left">
                    ¡Contactanos!
                </p>
