...
export const Title: React.FC<BlurTextProps> = ({
  text = '',
  delay = 200,
  className = '',
  animateBy = 'words',
  ...
  return (
    <h1 ref={ref} className={`blur-text ${className} flex flex-wrap text-white text-2xl md:text-3xl lg:text-4xl xl:text-5xl w-full`}>
      {springs.map((props, index) => (
        <AnimatedSpan
        key={index}
        style={props}
        className="inline-block will-change-[transform,filter,opacity] w-full md:w-auto"
        >
