...
import { ISsd, IProductImage } from "@/interfaces";
import { validSsdBrands, validSsdCapacities, validSsdFormats, validSsdTypes } from "@/utils";

interface Props {
    product: Partial<ISsd> & { ProductImage?: IProductImage[] } | undefined;
};
...
export const SsdForm = ({ product }: Props) => {
    ...
    const onSubmit = async (data: FormInputs) => {
        ...
        const { ok, message } = await createUpdateSsd(formData);
            ...
            <div className="grid mb-16 grid-cols-1 sm:grid-cols-2 gap-3 mt-5">
                ...
                <div className="w-full">
                    ...
                    <div className="flex flex-col mb-2">
                        ...
                        >
                            <option value="a8eb3ffe-648d-47cd-be86-e1e3cc11d2e6">Discos sólidos</option>
                        </select>
                    </div>
