...
import { createUpdateVideoCard, deleteProductImage } from "@/actions";
import { ProductImage, Button } from "@/components";
import { IVideoCard, IProductImage } from "@/interfaces";
import { validVCBrands, validVCConnection, validVCConnector, validVCResolution } from "@/utils";

interface Props {
    product: Partial<IVideoCard> & { ProductImage?: IProductImage[] } | undefined;
};
...
export const VideoCardForm = ({ product }: Props) => {
    ...
    const onSubmit = async (data: FormInputs) => {
        ...
        formData.append("connectorType", productToSave.connectorType);
        formData.append("connectionType", productToSave.connectionType);
        formData.append("resolution", productToSave.resolution);
        ...
        const { ok, message } = await createUpdateVideoCard(formData);
        ...
        router.replace("/admin/productos/placas-de-video");
    };
            ...
            <div className="grid mb-16 grid-cols-1 sm:grid-cols-2 gap-3 mt-5">
                ...
                <div className="w-full">
                    ...
                    <div className="flex flex-col mb-2">
                        ...
                        >
                            <option value="e70e0dff-4a46-447b-a638-317357ae7beb">Placas de video</option>
                        </select>
                    </div>
                    ...
                    <div className="flex flex-col lg:flex-row justify-between items-center gap-2">
                        ...
                        <div className="flex flex-col mb-2 w-full">
                            ...
                            <select
                                className="p-2 border rounded-md bg-slate-200 text-slate-800 capitalize"
                                {...register("connectorType", { required: true })}
                            >
                                <option value="">[Seleccione]</option>
                                {
                                    validVCConnector.map(opt => (
