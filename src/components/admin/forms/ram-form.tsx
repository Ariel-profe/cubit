...
import { createUpdateRam, deleteProductImage } from "@/actions";
import { ProductImage, Button } from "@/components";
import { IRam, IProductImage } from "@/interfaces";
import { validRamBrands, validRamCapacity, validRamSpeeds, validRamTypes } from "@/utils";


interface Props {
    product: Partial<IRam> & { ProductImage?: IProductImage[] } | undefined;
};
...
export const RamForm = ({ product }: Props) => {
    ...
    const onSubmit = async (data: FormInputs) => {
        ...
        const { ok, message } = await createUpdateRam(formData);
        ...
        router.replace("/admin/productos/rams");
    };
            ...
            <div className="grid mb-16 grid-cols-1 sm:grid-cols-2 gap-3 mt-5">
                ...
                <div className="w-full">
                    ...
                    <div className="flex flex-col mb-2">
                        ...
                        >
                            <option value="9aec2f1e-fc4a-4e68-b830-c402960f936f">Memorias ram</option>
                        </select>
                    </div>
