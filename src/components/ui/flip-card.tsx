          ...
          <div className="absolute inset-0 flex items-center justify-center pt-20">
            <div className="relative flex h-[100px] w-[200px] flex-col items-center justify-center gap-2">
              ...
              {[
                ...
                { width: '65%', marginLeft: '15%' },
                { width: '75%', marginLeft: '8%' },
                { width: '85%', marginLeft: '3%' },
              ].map((style, i) => (
                <div
                  key={i}
                  className={cn(
          ...
          <div className="absolute right-0 bottom-0 left-0 p-5">
            <div className="flex items-center justify-between gap-3">
              <div className="space-y-1.5">
                ...
                <p className="line-clamp-2 text-sm tracking-tight text-slate-300 transition-all delay-[50ms] duration-500 ease-out group-hover:translate-y-[-4px]">
                  {subtitle}
                </p>
              </div>
