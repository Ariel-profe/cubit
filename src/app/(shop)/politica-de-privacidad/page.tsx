...
export default function PrivacyPage() {
    return (
        <section className="container mx-auto px-3 mt-10 lg:mt-20">
            ...
            <p className="md:text-lg text-justify mb-5">
            ...
            <h4 className="text-lg md:text-xl font-bold text-slate-100">Cookies</h4>
            ...
            <h4 className="text-lg md:text-xl font-bold text-slate-100">Licencia</h4>
            ...
            <h4 className="text-lg md:text-xl font-bold text-slate-100">Aviso legal</h4>
