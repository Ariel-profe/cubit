...
import { details, features } from "@/lib/constants";

export const Features = () => {
  return (
        <section className="container mx-auto px-3 relative flex md:flex-wrap flex-nowrap border-2 border-s3 rounded-7xl md:overflow-hidden max-md:flex-col feature-after md:g7 max-md:border-none max-md:rounded-none max-md:gap-3 mt-20 lg:mt-40">
