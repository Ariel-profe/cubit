...
export const features = [
    {
      ...
      caption: "Precios amigables",
      title: "Ofertas constantes ",
      text: "Con Cúbit podes cumplir tu sueño de tener esos productos que tanto buscaste y soñaste.",
      button: {
    ...
    },
    {
      ...
      caption: "Seguridad y confianza",
      title: "Envíos gratis en el día",
      text: "En pocas horas podes tener los productos en tu lugar de ocio/trabajo para comenzar a usarlos.",
      button: {
  ...
  export const faq = [
    {
      id: "0",
      question: "Exercitation laborum officia labore?",
      answer:
        "Exercitation laborum officia labore incididunt eu exercitation sit laborum est.",
    },
    {
      id: "1",
      question: "Exercitation laborum officia labore?",
  ...
  export const plans = [
    ...
    },
    {
      ...
      priceMonthly: 39,
      priceYearly: 29,
      caption: "Productos profesionales",
      features: [
        "Stream desk",
        "Microfonos",
        "Auriculares",
  ...
  export const testimonials = [
    ...
    },
    {
      ...
      comment:
        "Eu ullamco exercitation sunt aliqua pariatur consectetur in eu ea minim veniam non qui do.",
    },
    {
      id: "2",
      name: "Pedro Mancilla",
